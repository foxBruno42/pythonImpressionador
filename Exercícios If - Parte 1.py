...
if(vendas_funcionario1 >=meta):
    print('O funcionário 1 ganhou ',(vendas_funcionario1*0.10),' de bônus')
else:
    print('O funcionário 1 ganhou 0 de bônus')

if(vendas_funcionario2 >=meta):
    print('O funcionário 2 ganhou {} de bônus',vendas_funcionario2*0.10)
else:
    print('O funcionário 2 ganhou 0 de bônus')

if(vendas_funcionario3 >=meta):
    print(f"O funcionário 3 ganhou {(vendas_funcionario3*0.10)} de bônus")
else:
...
if(vendas_funcionario2 >=2000):
    print('O funcionário 2 ganhou {} de bônus',vendas_funcionario2*0.15)
